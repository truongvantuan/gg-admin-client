<!--http://localhost:8090/#/oms/returnReason-->
<template>
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="returnReasonTable"
        ...
        <el-table-column label="Usable or Not" align="center">
        ...
        <el-table-column label="Created time" width="180" align="center">
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="handleConfirm">Sure</el-button>
      </span>
    </el-dialog>
  </div>
</template>
    ...
    methods: {
      ...
      handleBatchOperate(){
        if(this.multipleSelection==null||this.multipleSelection.length<1){
          this.$message({
            message: 'Please select the item to be operated',
            type: 'warning',
            duration: 1000
          });
          return;
