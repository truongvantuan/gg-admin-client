...
<template>
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <el-button size="mini" class="btn-add" @click="handleAdd()" style="margin-left: 20px">Add event</el-button>
      <el-button size="mini" class="btn-add" @click="handleShowSessionList()">Spike time list</el-button>
    </el-card>
    <div class="table-container">
      <el-table ref="flashTable"
        ...
        <el-table-column label="Event title" align="center">
        ...
        <el-table-column label="Operate" width="180" align="center">
          <template slot-scope="scope">
            <el-button size="mini"
                       type="text"
                       @click="handleSelectSession(scope.$index, scope.row)">Set up products
            </el-button>
            <el-button size="mini"
                       type="text"
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(index, row) {
        this.$confirm('Do you want to delete this event?', 'Hint', {
          confirmButtonText: 'Sure',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
