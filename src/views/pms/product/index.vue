  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="productTable"
        ...
        <el-table-column label="Label" width="180" align="right">
          <template slot-scope="scope">
            <p>On shelf：
              <el-switch
        ...
        <el-table-column label="Sales" width="60" align="center">
        ...
        <el-table-column label="Approval Status" width="100" align="center">
          <template slot-scope="scope">
            ...
            <p>
              <el-button
                type="text"
                @click="handleShowVerifyDetail(scope.$index, scope.row)">Reviews
              </el-button>
            </p>
          </template>
        </el-table-column>
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="handleEditSkuConfirm">Sure</el-button>
      </span>
    </el-dialog>
  </div>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        operates: [
          {
            label: "Merchandise on the shelf",
            value: "publishOn"
          },
          {
            label: "Commodity off the shelf",
            value: "publishOff"
          },
          {
    ...
    methods: {
      ...
      handleEditSkuConfirm(){
        ...
        this.$confirm('Do you want to modify', 'Hint', {
      ...
      handleBatchOperate() {
        ...
        this.$confirm('Do you want to perform this batch operation?', 'Hint', {
          confirmButtonText: 'Sure',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
