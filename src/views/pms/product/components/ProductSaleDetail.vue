...
<template>
  <div style="margin-top: 50px">
    <el-form :model="value" ref="productSaleForm" label-width="160px" style="width: 600px" size="small">
      ...
      <el-form-item label="Points purchase restriction：">
        <el-input v-model="value.usePointLimit"></el-input>
      </el-form-item>
      <el-form-item label="Preview goods：">
        <el-switch
      ...
      <el-form-item label="Merchandise on the shelf：">
        <el-switch
      ...
      <el-form-item label="Discount method：">
        <el-radio-group v-model="value.promotionType" size="small">
          ...
          <el-radio-button :label="3">Step Price</el-radio-button>
      ...
      <el-form-item style="text-align: center">
        <el-button size="medium" @click="handlePrev">Previous</el-button>
        <el-button type="primary" size="medium" @click="handleNext">Next</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
