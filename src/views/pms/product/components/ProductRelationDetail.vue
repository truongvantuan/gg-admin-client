  ...
  <div style="margin-top: 50px">
    <el-form :model="value"
      ...
      <el-form-item style="text-align: center">
        <el-button size="medium" @click="handlePrev">Previous, the product attributes</el-button>
        <el-button type="primary" size="medium" @click="handleFinishCommit">Finish, submit the product</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
  ...
  export default {
    ...
    data() {
      return {
        //List of all topics
        subjectList: [],
        //Topic left and right titles
        subjectTitles: ['Select all', 'Chosen'],
        //List of all topics
        prefrenceAreaList: [],
        //Topic left and right titles
        prefrenceAreaTitles: ['Select all', 'Chosen']
      };
    },
    created() {
      this.getSubjectList();
