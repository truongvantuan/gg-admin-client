<!--http://localhost:8090/#/pms/productAttrList?cid-->
<template>
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="productAttrTable"
        ...
        <el-table-column label="Whether the attribute is optional" width="150" align="center">
  ...
  export default {
    ...
    methods: {
      ...
      handleDeleteProductAttr(ids) {
        this.$confirm('Do you want to delete this attribute', 'Hint', {
