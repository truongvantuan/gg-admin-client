  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="menuTable"
        ...
        <el-table-column label="Menu level" width="120" align="center">
        ...
        <el-table-column label="Set up" width="120" align="center">
          <template slot-scope="scope">
            <el-button
              size="mini"
              type="text"
              :disabled="scope.row.level | disableNextLevel"
              @click="handleShowNextLevel(scope.$index, scope.row)">View sub-menu
            </el-button>
          </template>
        </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(index, row) {
        this.$confirm('Do you want to delete this menu', 'Hint', {
