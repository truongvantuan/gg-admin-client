  ...
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="Enter search：">
            <el-input v-model="listQuery.keyword" class="input-width" placeholder="keyword" clearable></el-input>
          </el-form-item>
        </el-form>
      </div>
    </el-card>
    ...
    <div class="table-container">
      <el-table ref="adminTable"
        ...
        <el-table-column label="User ID" width="80" align="center">
        ...
        <el-table-column label="Created time" width="160" align="center">
        ...
        <el-table-column label="Operate" width="210" align="center">
          <template slot-scope="scope">
            <el-button size="mini"
                       type="text"
                       @click="handleSelectRole(scope.$index, scope.row)">Edit Roles
            </el-button>
            <el-button size="mini"
                       type="text"
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="handleAllocDialogConfirm()" size="small">Sure</el-button>
      </span>
    </el-dialog>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(index, row) {
        this.$confirm('Do you want to delete this user?', 'Hint', {
          confirmButtonText: 'Sure',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
